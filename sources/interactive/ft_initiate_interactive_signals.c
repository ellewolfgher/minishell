...
/*   Updated: 2023/02/16 19:50:56 by ridalgo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->sa_ctrlc.sa_handler = ft_handle_interactive_signals;
	sigemptyset(&data->sa_ctrlc.sa_mask);
	data->sa_ctrlc.sa_flags = SA_RESTART;
	sigaction(SIGINT, &data->sa_ctrlc, NULL);
	data->sa_backslash.sa_handler = ft_handle_interactive_signals;
